...
class Fun_Commands(commands.Cog):
    ...
    async def chatbot(ctx, *, text: str):
        ...
        async with ctx.channel.typing(), ctx.bot.session.post("https://public-api.travitia.xyz/talk", json=payload, headers={"authorization": self.config.travitia_ket}) as req:
